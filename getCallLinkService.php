<?php 
	...
	include 'functions/getCallLinkFunction.php';
	...
	{
		$resultValue = getCallLinkFunction($username, $token);
	}
	else if ($error == false)
	{
	...
	else 
	{
		...
		$jsonelement = array("Page"=>$resultValue->linkaddress, "CallID"=>$resultValue->roomid);
		$myJSON = json_encode($jsonelement);
		echo $myJSON;
	}
?>