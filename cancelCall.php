<?php 
	...
	include 'functions/cancelCallFunction.php';
	...
	{
		$resultValue = cancelCallFunction($username, $token, $idcall);
	}
	else if ($error == true)
	{
	...
	if ( $resultValue->error == true )
	{
		...
		$jsonelement = array("Result"=>"Call not cancelled");
	...
	else 
	{
		...
		$jsonelement = array("Result"=>"Call cancelled");
		$myJSON = json_encode($jsonelement);
		echo $myJSON;
	}
?>